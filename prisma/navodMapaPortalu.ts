...
**Wikipedie** (Administrace → Wikipedie) je místo, kde si článek o sobě na Wikipedii napíšete a vyladíte: vlevo wikitext, vpravo náhled, jak ho vykreslí Wikipedie, a uložené verze, ke kterým se jde vrátit. Portál na Wikipedii nic neukládá. Text zkopírujete a vložíte tam sami svým účtem, návod je přímo na stránce. Až bude článek venku, napište jeho název do Hlídání a portál vám každou hodinu zvonkem ohlásí, když ho někdo upraví. Každý tu vidí jen svůj článek. V záložce **Údaje o sobě** se vyplní jméno, datum a místo narození, povolání, fotka z Commons, zdroje, milníky a tvorba; tlačítko **Sestavit text z údajů** z toho poskládá hotový wikitext včetně referencí. Text jde z portálu i **rovnou odeslat na Wikipedii** — stačí jednou vložit osobní přístupový token (OAuth „owner-only" z meta.wikimedia.org) a vyplnit, kam se má uložit; odesílá se poslední uložená verze a úprava jde pod vaším účtem.
