...
- **Rezervace studia klienty** — muzikanti a producenti, kteří si u nás bookují studio, mají vlastní kalendář na **/studio**: vidí volno, berou si termíny sami a rezervace platí hned. Svoje události vidí pojmenované, cizí (včetně našeho natáčení) jen jako obsazený čas bez názvů. Zapíná se u každého studia zvlášť v Administrace → Studia, tam se taky posílají pozvánky a odebírá přístup; totéž má pod kalendářem studia i **vedoucí pobočky** (panel Správa rezervací na /studio), takže kvůli pozvánce nemusí do administrace. Rezervace se zapíše rovnou do kalendáře studia jako událost druhu **Rezervace studia**, takže se počítá do obsazenosti i konfliktů a dá se u ní stejně jako u jiné události poznamenat zvukař nebo ji přepsat na jiný druh práce. Návod pro klienty je anglicky, čtou ho na **/studio/napoveda**. Klient si pod svým jménem nastaví údaje a tři upozornění: potvrzení rezervace, změna nebo zrušení termínu z naší strany (posílá se, když s rezervací v kalendáři hneme nebo ji smažeme) a připomínka den předem.
