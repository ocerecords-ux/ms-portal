...
- **Rezervace studia klienty** — muzikanti a producenti, kteří si u nás bookují studio, mají vlastní kalendář na **/studio**: vidí volno, berou si termíny sami a rezervace platí hned. Svoje události vidí pojmenované, cizí (včetně našeho natáčení) jen jako obsazený čas bez názvů. Zapíná se u každého studia zvlášť v Administrace → Studia, tam se taky posílají pozvánky a odebírá přístup. Rezervace se zapíše rovnou do kalendáře studia jako událost druhu **Rezervace studia**, takže se počítá do obsazenosti i konfliktů a dá se u ní stejně jako u jiné události poznamenat zvukař nebo ji přepsat na jiný druh práce. Návod pro klienty je anglicky, čtou ho na **/studio/napoveda**.
