...
export const MS_SMAJLICI: MsSmajlik[] = [
  ...
  { code: ':ms-slon:', label: 'Slon', svg: '<circle cx="12" cy="12" r="11" fill="#7B55FF"/><circle cx="6.9" cy="10.4" r="3.4" fill="#FFFFFF"/><circle cx="17.1" cy="10.4" r="3.4" fill="#FFFFFF"/><circle cx="12" cy="10.8" r="5.1" fill="#FFFFFF"/><path d="M12 15.4v2.2c0 1.2 1 2.2 2.2 2.2" stroke="#FFFFFF" stroke-width="2.3" stroke-linecap="round" fill="none"/><circle cx="10.1" cy="10.2" r="0.95" fill="#7B55FF"/><circle cx="13.9" cy="10.2" r="0.95" fill="#7B55FF"/>' },
  { code: ':ms-moucha:', label: 'Moucha', svg: '<circle cx="12" cy="12" r="11" fill="#7B55FF"/><ellipse cx="6.9" cy="9.6" rx="3.9" ry="2.3" transform="rotate(-28 6.9 9.6)" fill="#1FDF67"/><ellipse cx="17.1" cy="9.6" rx="3.9" ry="2.3" transform="rotate(28 17.1 9.6)" fill="#1FDF67"/><ellipse cx="12" cy="13.6" rx="2.9" ry="4.2" fill="#FFFFFF"/><circle cx="12" cy="8.4" r="2.6" fill="#FFFFFF"/><circle cx="10.9" cy="8.1" r="0.85" fill="#7B55FF"/><circle cx="13.1" cy="8.1" r="0.85" fill="#7B55FF"/>' },
];
