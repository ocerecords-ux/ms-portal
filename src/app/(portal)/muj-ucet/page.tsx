...
//
// Ukoly tymu Mediaspace uz tu nejsou - presunuly se do vysouvaciho panelu na
// prave hrane obrazovky, ktery je na kazde strance portalu (zadani 8. 9. 2026,
// viz components/TaskDock.tsx).
