...
- **Přehledy → Kapacita studií** — celý rok na jedné stránce: dvanáct měsíců, v každém řádek den a sloupec studio. Každý den je obdélníček — čím tmavší, tím víc **natáčení** proti otevírací době studia; prázdné místo je díra. Víkendy mají vlastní podklad, hodiny ukáže najetí myší. Střih, casting ani blokace se nepočítají. Admin a produkce.
